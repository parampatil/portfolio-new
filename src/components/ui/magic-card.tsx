...
export function MagicCard({
  ...
  return (
    ...
    >
      <div className="absolute inset-px z-10 rounded-xl bg-white dark:bg-zinc-950" />
      ...
      />
      <motion.div
        className="pointer-events-none absolute inset-0 rounded-xl bg-zinc-200 duration-300 group-hover:opacity-100 dark:bg-zinc-800"
        style={{
          background: useMotionTemplate`
